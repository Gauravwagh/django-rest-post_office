...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'post_office_email', 'template',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['email.EmailTemplate'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        u'email.attachment': {
            ...
            'emails': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'attachments'", 'symmetrical': 'False', 'to': u"orm['email.Email']"}),
        ...
        u'email.log': {
            ...
            'email': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'logs'", 'to': u"orm['email.Email']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
