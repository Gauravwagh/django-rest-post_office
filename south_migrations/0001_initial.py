...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('post_office_log', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.related.ForeignKey')(related_name='logs', to=orm['email.Email'])),
        ...
        db.send_create_signal('email', ['Log'])
    ...
    models = {
        ...
        'email.log': {
            ...
            'email': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'logs'", 'to': "orm['email.Email']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
