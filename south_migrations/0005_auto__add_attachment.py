...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'email', ['Attachment'])
        ...
        db.create_table(m2m_table_name, (
            ...
            ('attachment', models.ForeignKey(orm[u'email.attachment'], null=False)),
            ('email', models.ForeignKey(orm[u'email.email'], null=False))
        ))
