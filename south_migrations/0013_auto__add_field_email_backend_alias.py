...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Email.backend_alias'
        db.add_column(u'post_office_email', 'backend_alias',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Email.backend_alias'
        db.delete_column(u'post_office_email', 'backend_alias')


    models = {
        u'email.attachment': {
            'Meta': {'object_name': 'Attachment'},
            'emails': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "u'attachments'", 'symmetrical': 'False', 'to': u"orm['email.Email']"}),
        ...
        u'email.email': {
            ...
            'backend_alias': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '64', 'blank': 'True'}),
            ...
            'template': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['email.EmailTemplate']", 'null': 'True', 'blank': 'True'}),
            'to': ('django.db.models.fields.TextField', [], {'blank': 'True'})
        },
        u'email.emailtemplate': {
            'Meta': {'unique_together': "((u'language', u'default_template'),)", 'object_name': 'EmailTemplate'},
            'content': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'default_template': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "u'translated_templates'", 'null': 'True', 'to': u"orm['email.EmailTemplate']"}),
        ...
        u'email.log': {
            ...
            'email': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'logs'", 'to': u"orm['email.Email']"}),
